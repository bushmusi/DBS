<!--Section: Contact v.2-->
<section class="row mb-4 mt-2 ml-3 float-left">
    <div class="row ">
        <div class="col-sm-4">
            <!-- Material input -->
            <div class="md-form">
        ...
        <div class="col-sm-4">
            ...
            <div class="md-form">
                ...
                <label for="form1">Middle Name</label>
            </div>
        </div>
        <div class="col-sm-4">
            <!-- Material input -->
...
<!--Section: Contact v.2--><?php /**PATH C:\Users\Bisrat\Desktop\Laravel\blog\resources\views/encoder/user-add.blade.php ENDPATH**/ ?>